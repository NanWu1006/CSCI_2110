...
public class Test {
    ...
    static void Test2() {
        ...
        myAssert(QuestionThree.addSLists(L1, L2).toString().equals("[2, 0, 2, 2]"), "Test #2");
    }
    ...
    static void Test3() {
        ...
        myAssert(QuestionThree.addSLists(L1, L2).toString().equals("[0, 0, 1]"), "Test #3");
    }
    ...
    static void Test4() {
        ...
        myAssert(QuestionThree.addSLists(L1, L2).toString().equals("[8, 9, 7]"), "Test #4");
    }
    ...
    static void Test5() {
        ...
        myAssert(QuestionThree.addSLists(L1, L2).toString().equals("[0, 3, 9]"), "Test #5");
    }
}
