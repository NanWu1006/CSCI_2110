...
public class BinaryTree<T extends Comparable<? super T>> {
	...
	private void inorder(BinaryTree<T> binaryTree) {
		if (binaryTree == null) {
			return;
		}
	...
	private void getInorder(BinaryTree<T> binaryTree, ArrayList<String> result) {
		if (binaryTree == null) {
			return;
		}
	...
	private void postorder(BinaryTree<T> binaryTree) {
		if (binaryTree == null) {
			return;
		}
		inorder(binaryTree.left);
	...
	private void preorder(BinaryTree<T> binaryTree) {
		if (binaryTree == null) {
			return;
		}
		System.out.println(binaryTree.getData());
	...
	private void getPreorder(BinaryTree<T> binaryTree, ArrayList<String> result) {
		if (binaryTree == null) {
			return;
		}
		result.add(binaryTree.getData().toString());
	...
	private int depth(BinaryTree<T> binaryTree, int tmp) {
	...
	private void ancestors(BinaryTree<T> node) {
		if (node != null) {
	...
	private boolean checkBS(BinaryTree<T> binaryTree, T minData, T maxData) {
		if (binaryTree == null) {
			return true;
		}
	...
	boolean checkHB(BinaryTree<T> binaryTree) {
		int LHSDepth;
		int RHSDepth;
